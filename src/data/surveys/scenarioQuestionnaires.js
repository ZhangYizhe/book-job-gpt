...
export const scenarioQuestionnaires = reactive({
    'book': {
        ...
        description: "For this step, we would like to ask you to use a book chatbot based on ChatGPT to complete the following task: <br><br><strong style='font-size: 1.4rem; font-weight: bold;'>Book recommendation task:</strong>" +
            ...
            + "\n- <strong>You could ask the bot for more details about a recommended item.</strong> E.g., ask about the abstract for a book."
            + "\n- <strong>You could also ask the bot to adjust the recommendations.</strong> E.g., ask the bot to recommend some books about American history.",
        type: "scenario-study",
        task: "book",
