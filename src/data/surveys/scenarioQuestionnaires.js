...
export const scenarioQuestionnaires = reactive({
    'book': {
        ...
        description: "The most important thing when communicating with the bot is to understand how to correctly and fully express your needs. The more information you provide, the more it may return ideal results.\n\n<strong style='font-size: 1.4rem; font-weight: bold;'>Book recommendation</strong>" +
            "<br>" +
            "You are about to embark on a summer vacation. You have planned to utilise this time off to read some books of your interest. For this task, please create a reading list by using the chatbot.<br><br><strong>Note:</strong>\n- You need to choose <strong>FIVE books </strong>for creating the wish list.",
        type: "scenario-study",
        task: "book",
    ...
    'job': {
        ...
        description: "The most important thing when communicating with the bot is to understand how to correctly and fully express your needs. The more information you provide, the more it may return ideal results.\n\n<strong style='font-size: 1.4rem; font-weight: bold;'>Job type recommendation</strong><br>You want to communicate with a job chatbot to know what types of jobs your skills and/or knowledge might be fit for. For this task, please create a wish list by using the chatbot.<br><br><strong>Notes:</strong>\n- You need to choose <strong>FIVE job types</strong> for creating the wish list.\n- This job chatbot is designed to provide recommendations for <strong>job types</strong>, not for specific job positions.",
        type: "scenario-study",
        task: "job",
