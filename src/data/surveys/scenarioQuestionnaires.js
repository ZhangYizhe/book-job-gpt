...
export const scenarioQuestionnaires = reactive({
    'book': {
        ...
        description: "<span style='color: red'>For this step, we would like to ask you to use a book chatbot based on ChatGPT to complete the following task:</span> <br><br><strong style='font-size: 1.4rem; font-weight: bold;'>Book recommendation task:</strong>" +
            "<br>" +
