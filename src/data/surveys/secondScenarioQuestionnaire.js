    ...
    data: [
        {
            ...
            options: [
                {
                    id: 1,
                    text: 'Hello, I want to generate a book list. I will read the items on the book list during the holidays. I hope they help me pass the time and improve myself. Because I don\'t usually like reading, I don\'t know which items are better. Maybe you can help me, so that I can easily choose the book I like. Thank you for your help.',
                },
                {
                    id: 2,
                    text: 'I like reading very much, and I plan to arrange to read 5 items in the next vacation. I hope them can improve my insight. These items must be suitable for me to read and can broaden my horizons. I am very interesting in the field of technologies. Maybe I can learn more about this field, and I can choose items by myself in the future.',
                },
                {
                    id: 3,
        ...
        {
            id: 4,
            title: 'About the second task, who do you want to choose items for?',
            type: 'text',
            value: null,
            required: true,
        },
