import{q as Yu}from"./index-e483dd6f.js";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class er{constructor(t,n){this.previousValue=t,n&&(n.sequenceNumberHandler=s=>this.ot(s),this.ut=s=>n.writeSequenceNumber(s))}ot(t){return this.previousValue=Math.max(t,this.previousValue),this.previousValue}next(){const t=++this.previousValue;return this.ut&&this.ut(t),t}}er.ct=-1;function ds(e){return e==null}function Bn(e){return e===0&&1/e==-1/0}function Kd(e){return typeof e=="number"&&Number.isInteger(e)&&!Bn(e)&&e<=Number.MAX_SAFE_INTEGER&&e>=Number.MIN_SAFE_INTEGER}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function nr(e){var t,n;return((n=(((t=e==null?void 0:e.mapValue)===null||t===void 0?void 0:t.fields)||{}).__type__)===null||n===void 0?void 0:n.stringValue)==="server_timestamp"}function sr(e){const t=e.mapValue.fields.__previous_value__;return nr(t)?sr(t):t}function Qe(e){const t=Ft(e.mapValue.fields.__local_write_time__.timestampValue);return new U(t.seconds,t.nanos)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function _c(e,t){if(e.useProto3Json){if(isNaN(t))return{doubleValue:"NaN"};if(t===1/0)return{doubleValue:"Infinity"};if(t===-1/0)return{doubleValue:"-Infinity"}}return{doubleValue:Bn(t)?"-0":t}}function Nc(e){return{integerValue:""+e}}function yf(e,t){return Kd(t)?Nc(t):_c(e,t)}/**
 * @license
 * Copyright 2018 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Mr(e){let t;const n=await Ds(e.appConfig,s=>{const i=gm(s),r=pm(e,i);return t=r.registrationPromise,r.installationEntry});return n.fid===_i?{installationEntry:await t}:{installationEntry:n,registrationPromise:t}}function gm(e){const t=e||{fid:am(),registrationStatus:0};return Bu(t)}function pm(e,t){if(t.registrationStatus===0){if(!navigator.onLine){const i=Promise.reject(te.create("app-offline"));return{installationEntry:t,registrationPromise:i}}const n={fid:t.fid,registrationStatus:1,registrationTime:Date.now()},s=mm(e,n);return{installationEntry:n,registrationPromise:s}}else return t.registrationStatus===1?{installationEntry:t,registrationPromise:ym(e)}:{installationEntry:t}}async function mm(e,t){try{const n=await im(e,t);return Qn(e.appConfig,n)}catch(n){throw Nu(n)&&n.customData.serverCode===409?await Uu(e.appConfig):await Qn(e.appConfig,{fid:t.fid,registrationStatus:0}),n}}async function ym(e){let t=await zo(e.appConfig);for(;t.registrationStatus===1;)await Pu(100),t=await zo(e.appConfig);if(t.registrationStatus===0){const{installationEntry:n,registrationPromise:s}=await Mr(e);return s||n}return t}function zo(e){return Ds(e,t=>{if(!t)throw te.create("installation-not-found");return Bu(t)})}function Bu(e){return vm(e)?{fid:e.fid,registrationStatus:0}:e}function vm(e){return e.registrationStatus===1&&e.registrationTime+Du<Date.now()}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
